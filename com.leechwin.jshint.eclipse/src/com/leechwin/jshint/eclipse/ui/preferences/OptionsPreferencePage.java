package com.leechwin.jshint.eclipse.ui.preferences;
...
import com.leechwin.jshint.eclipse.builder.Excluder;
...
public class OptionsPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
    ...
    private static final String PAGE_TITLE = "JSHint";
    ...
    private void createOtherPrefsArea(Composite main) {
        ...
        addIntegerFieldEditor(parent, Option.ESVERSION);
        addIntegerFieldEditor(parent, Option.MAXERR);
        addIntegerFieldEditor(parent, Option.MAXPARAMS);
